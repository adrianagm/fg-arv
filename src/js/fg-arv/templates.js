    ...
    return {
      ...
      createFormTemplate: function() {
        return '' +
          ...
          "<form>" +
          "<div class='form col-xs-12 col-sm-12 col-md-10'>" +
          "<div class='form-components-container'>" +
          "<div class='col-xs-12 col-sm-5 form-component from-component'></div>" +
          ...
          "</div>" +
          "</form>" +
          "<div class='fg-arv_info-journey-component col-xs-12 col-sm-8 col-md-6'></div>" +
          "</div>";
      }
    };
  });
